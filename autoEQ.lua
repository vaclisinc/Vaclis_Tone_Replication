-- === CONFIG ===
local combos = dofile("/YOUR_VTR_DIR/audio_samples/reaper/batch_XX.lua")

local input_dir = "/YOUR_VTR_DIR/audio_samples/reaper/raw"
local output_dir = "/YOUR_VTR_DIR/audio_samples/reaper/processed/"
